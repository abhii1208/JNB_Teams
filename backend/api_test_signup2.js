...
async function signup() {
  const body = {
    email: 'test.user2+autocreate@example.com',
    username: 'testautouser2',
  ...
  try {
    ...
    // query DB
    const u = await pool.query("SELECT id, username, email FROM users WHERE username = 'testautouser2'");
